 ...
 */
 function typewrite()
 {
     let str="每个人都有过去，不一定非要忘掉过去<但一定要放下过去，让心归零，然后释怀一切；愿你看淡生活中的渐行渐远<有前进一寸的勇气，亦有后退一尺的从容<小吴赠< 静静等待20秒哦！ ";//利用<作为换行符 -作为空格
...
let clickb=false;//判断播放按钮是否已经按过了，如果已经按过了才可以执行键盘事件
 ...
 let a=[
     ...
     {name:"G" ,yin:3, str:"<br><br>我试图用那些漂亮的句子来形容你。但是不行<br><br>我字字推敲写出长长一段话，你眉眼一弯熠熠生辉，就让我觉得。不行<br><br>这些文字写不出你眼里的星辰，写不出你唇角的春风<br></br>无论哪个词，都及不上你半分的惊艳。"},
     ...
     {name:"O" ,yin:7, str:"<br><br><br><br>女孩的裙摆撑得起所有温柔和盛夏<br><br>或者在灯光下谈心，<br><br>知足而上进 温柔而坚定<br><br>别灰心 普普通通的你也值得被万般宠溺音。"},
