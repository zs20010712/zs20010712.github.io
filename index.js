 ...
 */
 function typewrite()
 {
     let str="周珊，我想对你说：<每个人都有过去，不一定非要忘掉过去<但一定要放下过去，让心归零，然后释怀一切；愿你看淡生活中的渐行渐远<有前进一寸的勇气，亦有后退一尺的从容<小吴赠< 静静等待20秒哦！ ";//利用<作为换行符 -作为空格
...
let clickb=false;//判断播放按钮是否已经按过了，如果已经按过了才可以执行键盘事件
 ...
 let a=[
     ...
     {name:"G" ,yin:3, str:"<br><br>我试图用那些漂亮的句子来形容你。但是不行<br><br>我字字推敲写出长长一段话，你眉眼一弯熠熠生辉<br><br>就让我觉得这些文字写不出你眼里的星辰，写不出你唇角的春风<br></br>无论哪个词，都及不上你半分的惊艳。"},
